...
void UiPanel::build ()
{
    ...
    // Array to gather ranges of elements of same type for alignment:
	GsArray<int> egroups;
	...
	{	e = get(i);
		...
		// Check if item is a button with submenu attached:
		if ( e->type()==UiElement::Button && ((UiButton*)get(i))->submenu() )
