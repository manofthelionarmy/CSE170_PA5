...
/*	UiDev: initial steps have been taken but these are still not implemented:
	1) accelerators, and 2) keyboard navigation in panels.
*/
...
# define SETCMDKEY(ck,k,cm,a,c,s) { ck.key=k; ck.cmd=cm; ck.alt=a; ck.ctrl=c; ck.shift=s; }

void UiManager::cmd_key ( int key, int cmd, gscbool alt, gscbool ctrl, gscbool shift )
{
